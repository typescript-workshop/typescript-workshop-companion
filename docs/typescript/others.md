...
- [Configuration - Inlay hints](https://code.visualstudio.com/docs/typescript/typescript-editing#_inlay-hints)
- [Extension - Twoslash Query Comments](https://github.com/orta/vscode-twoslash-queries)
- [Extension - Pretty TS errors](https://marketplace.visualstudio.com/items/?itemName=yoavbls.pretty-ts-errors)
